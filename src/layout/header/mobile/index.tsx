  ...
  return (
    <div className="relative block [--mobile-height:64px] lg:hidden">
      ...
      <div className={headerWrapperClasses}>
        {/* Menubar  */}
        <div className="flex h-[--mobile-height,64px] items-center justify-between gap-4 border-b border-white bg-white/90 py-2 backdrop-blur-md dark:border-white dark:bg-white">
